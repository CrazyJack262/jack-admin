...
public class ResourceController {
    ...
    @ApiOperation(value = "新增资源", notes = "新增资源", response = SystemResource.class)
    @PostMapping
    public Object saveUser(@RequestBody SystemResource vo) {
        return Result.ok(resourceService.save(vo));
    }
}
